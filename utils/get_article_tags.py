...
# @Author     : HUII
# @File       : get_article_tags.py
# @Description:获得文章标签,使用jieba库实现
def get_tags(article_content: str) -> list:
    import jieba.analyse
    tags = jieba.analyse.extract_tags(article_content, topK=10,
                                      withWeight=True,
                                      allowPOS=('ns', 'vn', 'n'))
    res = [i[0] for i in tags if i[1] > 0.10]
    return res


if __name__ == '__main__':
    arc = """在四川省成都市淮州新城通威太阳能(金堂)有限公司，通过参观通道全透明玻璃，企业的电池片生产过程一览无余。无尘车间内IGV智能小车来回穿梭，机械臂有序挥舞，训练有素、身着不同颜色工装的工人在设备屏幕前操作系统……这是一座现代化高效智能5G晶硅电池片的“超级工厂”。
    ...
    为了推进项目落地见效，金堂县多次召开专题会议，积极组织相关部门对难点进行沟通协调，政府与公司组建联合指挥部，助推项目落地跑出“加速度”。
    
    据了解，通威太阳能光伏产业基地项目总投资约200亿元，建设年产30GW高效太阳能电池及配套项目，其中，一期6.6GW项目于2020年3月25日开工建设。从去年5月8日第一台设备进场，到第一片电池片下线，仅用了20天。
    ...
    “在金堂县和淮州新城布局节能环保产业、实施环境基础设施建设，机遇难得、未来可期、大有作为。”在今年3月25日召开的四川省节能环保产业暨环保基础设施招商会上，金堂县委书记、淮州新城党工委书记钟静远说。
    ...
    为了让落地企业“拎包”入驻，金堂县准备了一整套的“大礼包”，包括：在淮州新城配套有完善的水、电、气基础设施；建成上百万平方米的标准化厂房、高品质科创空间；实行企业秘书制和企业联络员制，推出工商注册全程“跑腿帮办”，设置重大项目“绿色通道”，开通24小时“不打烊”招商热线等，全力做好项目落地要素保障，及时打通难点堵点问题。
